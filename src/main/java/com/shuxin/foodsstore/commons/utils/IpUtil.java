...
import com.shuxin.foodsstore.model.IpInfo;
...
public class IpUtil {
    ...
    public static void main(String[] args){
        ...
        //getIpInfo("192.168.0.93");
    }

    /**
     *
     * 功能:  客户端信息(ip+端口+浏览器版本)
     * 名称:  getClientInfo
     * 作者 :  lucs
     * 时间 :  2015年3月19日 上午9:33:03
     * 参数:  @param request
     * 参数:  @return
     */
    public static String getClientInfo(HttpServletRequest request){
        return getIpAddr(request)+":"+request.getRemotePort()+":"+request.getHeader("User-agent");
    }
