...
<head>
    ...
    <link rel="stylesheet" href="${base}/static/css/font-awesome/css/font-awesome.min.css">
...
<div class="layui-layout layui-layout-admin" style="border-bottom: solid 5px #1aa094;">
            ...
            <ul class="layui-nav admin-header-item">
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;" class="admin-header-user">
                        <img src="${base}/static/img/headicon.png" />
                        <span>beginner</span>
                    </a>
    ...
    <script type="text/javascript" src="${base}/static/js/datas/nav.js"></script>
    <script src="${base}/static/js/beginner/index.js"></script>
    <script>
