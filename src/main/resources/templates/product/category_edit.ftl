    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="categoryName" lay-verify="required" autocomplete="off" placeholder="请输类目名称" class="layui-input" value="${category.categoryName}">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">排序ID</label>
            <div class="layui-input-inline">
                <input type="text" name="categorySerial" lay-verify="required" placeholder="请输入排序ID" autocomplete="off" class="layui-input" value="${category.categorySerial}">
            </div>
        </div>
        ...
        <div class="layui-input-inline">
            <select name="categoryType" >
                <#if category.categoryType == 1 >
                    <option value="1" selected ="">精致正餐</option>
                    <option value="2" >小炒菜品</option>
                <#else>
                    <option value="1" >精致正餐</option>
                    <option value="2" selected ="">小炒菜品</option>
                </#if>
            </select>
        </div>
