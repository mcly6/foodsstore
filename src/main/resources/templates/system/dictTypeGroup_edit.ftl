...
<form class="layui-form" action="${base}/dict/addType" id="menuinfo">
    <input  type="hidden" id="id" name="id" value="${typeGroup.id}"/>
    <div class="layui-form-item">

            <label class="layui-form-label">字典类型名称</label>
            <div class="layui-input-inline">
                <input type="text" name="typegroupname" value="${typeGroup.typegroupname}" lay-verify="required" autocomplete="off" placeholder="请输入字典类型名称" class="layui-input">
            </div>
    </div>
    <div class="layui-form-item">
            <label class="layui-form-label">字典类型编码</label>
            <div class="layui-input-inline">
                <input type="tel" name="typegroupcode"  value="${typeGroup.typegroupcode}" lay-verify="required" placeholder="字典类型编码" autocomplete="off" class="layui-input">
            </div>
