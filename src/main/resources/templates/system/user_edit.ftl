...
<form class="layui-form" action="${base}/user/add" id="userInfo">
    ...
    <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="nickname" value="${(user.nickname)!}" lay-verify="required" autocomplete="off" placeholder="请输入用户昵称" class="layui-input">
            </div>
    </div>
    <div class="layui-form-item">
            <label class="layui-form-label">账号</label>
            <div class="layui-input-inline">
                <input type="tel" name="username"  value="${(user.username)!}" lay-verify="required" placeholder="请输入账号名" autocomplete="off" class="layui-input">
            </div>
                ...
                <select name="type" lay-filter="type" lay-verify="required">
                   ...
                   <#list typeList as type>
                        <#if type.code == user.type>
                            <option value="${type.code}" selected="selected">${type.message}</option>
                        <#else >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="tel" name="hosNum"   value="${(user.hosNum)!}" placeholder="请设置资源排序" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
